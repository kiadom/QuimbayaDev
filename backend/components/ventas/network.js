...
router.post('/', function(req, res){
    controller.registrarVenta(req.body.venta_id, req.body.venta_total, req.body.cantidad, req.body.precio_unitario_por_producto, req.body.fecha_venta, req.body.cliente_id, req.body.nombre_cliente, req.body.vendedor, req.body.estado)
        .then((fullVenta) => {
...
router.patch('/:venta_id', function(req, res){
    controller.actualizarVenta(req.params.venta_id, req.body.venta_total, req.body.cantidad, req.body.precio_unitario_por_producto, req.body.fecha_venta, req.body.cliente_id, req.body.nombre_cliente, req.body.vendedor, req.body.estado)
        .then((data) => {
